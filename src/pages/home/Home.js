				...
				<Row className="d-flex">
					<Col xs={12} lg={7} className="text-center">
						...
						<div className="d-flex justify-content-center py-4">
							<a href="https://www.linkedin.com/in/ana%C3%AFs-choquet/" target="_blank" rel="noopener noreferrer"><img src={ linkedin } className="social" id="linkedin" alt="Logo Linkedin"/></a>
